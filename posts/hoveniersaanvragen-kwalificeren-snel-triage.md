...
![Hovenier kijkt op zijn smartphone naar een aanvraag in een tuin met aanlegtools en plantenpot](/images/blog/hoveniersaanvragen-kwalificeren-snel-triage-2.jpg)
...
Onze [voice AI dienst](/voice-ai) kan deze vijf vragen ook automatisch stellen via inkomende oproepen, met automatische scoring. Bekijk onze [tarieven](/tarieven) als je dit volledig wilt laten opzetten.
...
Eens per kwartaal. Kijk naar welke A-leads niet converteerden (was je inschatting fout?) en welke C-leads onverwacht wel kochten (wat miste je?). Onze pagina over [reviews](/reviews) gaat dieper in op leren van klantfeedback.
