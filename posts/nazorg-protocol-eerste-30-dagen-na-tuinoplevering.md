...
seoTitle: "Eerste 30 dagen na tuinoplevering"
excerpt: "Drie weken na de oplevering belt de klant: dode planten, geel gras, geld terug. Dit nazorg-protocol voorkomt 80% van die telefoontjes."
date: "2026-04-25"
...
![Werkbank van een Nederlandse hovenier in zacht avondlicht: smartphone met foto van een net opgeleverde tuin, snoeischaar, klembord met onderhoudschema, kleine grondmonster-bakjes en een mok met thee](/images/blog/nazorg-protocol-eerste-30-dagen-na-tuinoplevering-2.jpg)
...
Voor reviews timing is dit moment ideaal: de tuin staat een maand, eventuele aanvang-klachten zijn opgelost, en de klant heeft net je expertise opnieuw gezien. De review-aanvraag converteert in deze fase typisch 50-70% van klanten in een 5-sterren Google review via [Reviews](https://www.hovenierai.nl/reviews).
...
**Niveau 2 — Hovenier-software met workflow-triggers** (€30-€80/maand). Voor hoveniersbedrijven met 12-50 opleveringen per jaar. Zodra je een project op "opgeleverd" zet, trigger automatisch de 4 berichten met geschreven templates. Bekijk de [tarieven van HovenierAI](https://www.hovenierai.nl/tarieven) voor pakketten waarin deze workflow standaard zit.

**Niveau 3 — AI-laag boven je hovenier-software** (€97-€297/maand). Een AI-systeem dat het volledige protocol uitvoert: stuurt de berichten op het juiste moment, vraagt de klant proactief om foto's, beoordeelt automatisch of een foto-zorg een professionele check vereist of een geruststellend antwoord, en escaleert klachten naar je inbox. Voor hoveniers met 50+ opleveringen per jaar of meerdere teams de meest rendabele combinatie. Een [AI-chatbot](https://www.hovenierai.nl/chatbot) op je website vangt verder alle vragen op die buiten kantooruren binnenkomen.

Voor inkomende telefoongesprekken (boze klant belt om 19:00 over een dood-plant) werkt de [AI telefonist](https://www.hovenierai.nl/voice-ai) als eerste opvang: vriendelijk de zorg erkennen, foto-toezending vragen, en een terugbel-afspraak inplannen voor de volgende werkdag — voorkomt dat de klant in zijn boosheid een review-app opent.
